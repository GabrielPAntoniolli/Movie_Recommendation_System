...
import project.recommender.rater.RaterDatabase;
import project.recommender.ratings.FourthRatings;
...
public class RecommendationRunner implements Recommender
{
	...
	public List<String> getItemsToRate() 
	{
		...
		for(int i = 0; i < 15; i++)
		{
			...
			String randomLyChosenMovieID = fullMovieList.get(movieID);
			movieListToRate.add(randomLyChosenMovieID);
